...
<html>
<head>
	<title>Bela Óptica | Cadastro</title>
...
<body>
    ...
    <section class="sec_fale">
    	<div class="container">
    		<div class="metade">
    			<form method="POST" action="logincadastro.php" name="formlogin">
    				...
    				<input type="password" name="senha" id="senha" id="senha" placeholder="Digite sua senha"required>
    				<br><br>
    				<button type="submit" class="btn_destaque">Cadastre-se</button>
    			</form>
    		</div>
    		<div class="metade">
    			<div>
    ...
    <footer>
    	<div class="container">
            ...
            <div class="um_terco">
            	<h3>Contato</h3>
            	<p>
            		<strong>Endereço:</strong> Brasil, SP Rua Deputado Salvador Julianelli,
                    Barra Funda, São Paulo.
                </p>
                <p>
                	<strong>Telefone:</strong> <a href="tel:33333333"> 3333-3333.</a>
                </p>                   
                <p>
